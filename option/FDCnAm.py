# -*- coding: utf-8 -*-
"""
Created on Fri Dec 28 15:19:07 2018
...
class FDCnAm(FDCnEu):
    """ An instance of FDCnEu
    """
    ### Overwrit the initialize function
    # Tol is crucial parameter here 
    # always make tol like 10**(-8)
    def __init__( self, S0, K, r, T, 
                  sigma, Smax, M, N, 
                  omega, tol, is_call = True ):
    ...
    def _traverse_grid_(self):
        """ Slove using linear system of equations
        """
            ...
            while self.tol < error:
                ...
                for  k in range(self.M-2)[1:]:
                    new_values[k] = max( self.payoffs[k],
                                         ...
                                         (rhs[k]+ self.alpha[k+1]*new_values[k-1] - (1-self.beta[k+1])*old_values[k]+self.gamma[k+1]*old_values[k+1]))
...
###--- Quick testing ---###
# Tol is crucial parameter here
#opt1 = FDCnAm( 50, 50, 0.1, 5.0/12.0, 
#               0.4, 100, 100, 42, 
#               1.2, 0.0000001, True )
#print(opt1.price())
#
#opt2 = FDCnAm( 50, 50, 0.1, 5.0/12.0, 
#               0.4, 100, 100, 42, 
#               1.2, 0.0000000055, False )
#print(opt2.price())
